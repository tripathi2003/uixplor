...
export default function Header() {
    ...
    return (
        <>
            <header
                className="fixed top-0 left-0 right-0 z-50 transition-[background,border-bottom,box-shadow] duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]"
                style={{
                    background: scrolled
                        ? 'rgba(10,10,15,0.88)'
                        : 'rgba(10,10,15,0.6)',
            ...
            <AnimatePresence>
                {menuOpen && (
                    ...
                    >
                        {/* Backdrop — solid opaque bg instead of expensive backdrop-filter blur */}
                        <div
                        ...
                        >
                            ...
                            {/* Nav grid — single stagger parent, no individual motion.div per link */}
                                    ...
                                    {navGroups.map((group, gi) => (
                                        <motion.div
                                            ...
                                            variants={{
                                                hidden: {},
                                                visible: {
                                                    transition: { staggerChildren: 0.03, delayChildren: 0.08 + gi * 0.06 }
                                                }
                                            }}
                                        >
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <Link
                                                                href={link.href}
                                                                onClick={() => setMenuOpen(false)}
                                                                className="flex flex-col gap-2 p-4 rounded-2xl border transition-[background,border-color,transform] duration-200 hover:-translate-y-px"
                                                                style={{
                                                                ...
                                                                onMouseLeave={e => {
                                                                    e.currentTarget.style.background = isActive ? `${link.color}12` : 'rgba(255,255,255,0.03)';
                                                                    e.currentTarget.style.borderColor = isActive ? `${link.color}40` : 'rgba(255,255,255,0.06)';
                                                                }}
                                                            >
                                                                <div
                            ...
                            <div className="px-8 py-4 border-t flex items-center justify-between" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
                                ...
                                <Link
                                    href="/collections"
                                    onClick={() => setMenuOpen(false)}
                                    className="inline-flex items-center gap-1.5 px-5 py-2 text-xs font-bold rounded-full transition-colors duration-200"
